# Trends in Education, Training, and Development

Wednesday, June 24, 2026 -- Kristen's side yard

## Background

Four people. Four vantage points on education. All at pivots.

- **Michael** -- corporate training for software developers; systems thinker; Liberating Structures practitioner
- **Marie** -- Brevard College librarian, then business school faculty; recently emeritus; decades of institutional memory
...
| Harvest   | Stone soup: each names what they want each other to carry away           | 30 min       |
| **Total** |                                                                          | **~4 hours** |

### Suggested LS Structures

| Structure                   | Role in this session                                                                          |
|-----------------------------|-----------------------------------------------------------------------------------------------|
| **Conversation Café**       | The spine of the evening -- talking piece, rounds, ground rules about listening to understand |
| **1-2-4-All**               | Opening: surfaces individual perspective before group dynamics take over                      |
| **Impromptu Networking**    | Alternative opening: 2 pair rotations with a single prompt to build early warmth              |
| **Ecocycle Planning**       | Frame for Q3 -- maps poverty trap / creativity trap / emergence visually                      |
| **What, So What, Now What** | The natural arc across all 3 questions taken together                                         |
| **WINFY**                   | Optional closing: each person names one specific ask of the group                             |

## Announcement

**When:** Wednesday, June 24, 2026, [TIME TBD] -- dinner, ~4 hours
...
**Option A -- Wendy invocation:** Wendy sets intention intuitively, without scripting or getting in anyone's head. Brief, grounding. Then into 1-2-4.
