# Open Space Sessions (EST)

## Session 0 — 10:00–10:45 (EST)

### Intro and Marketplace
...
|-----------------------------------------------------------------------------------------------|-------------------|----------|----------|
| Co-evolving Practices with LLM-assisted Coding (assuming humans)                              | Allan Stewart     | 1.Red    |          |
| What do you want from your manager?                                                           | Chris Stone       | 1.Orange |          |
| Hexagonal / Ports & Adapters Architecture – Why are we doing anything else?                   | Gus Murphy        | 1.Green  |          |
| How to run “npm install” without compromising your system (sandboxing, supply-chain security) | Raimo             | 1.Purple |          |
| I know this code stinks. Now how do I explain that?                                           | Ellis             | 1.Pink   |          |
| Technical facilitation 101 – why techies need facilitation skills                             | Karol Skrzymowski | 1.Beyond |          |
...
| Neuro-Spicy at work                                                 | Paige             | 2.Yellow |          |
...
| Thoughts on (Modern?) Software Development – “The Current Hype of AI” | Alexander Thurow             | 4.Yellow |          |
...
| Topic                                                                      | Leader       | Space       | Attended |
|----------------------------------------------------------------------------|--------------|-------------|----------|
| A Healthy Approach to Observability – Ending the Noise, Minding the Signal | Chris Stone  | 5.Red       |          |
| What do you wish you knew the first time you applied for a job?            | Harry Cook   | 5.Orange    |          |
